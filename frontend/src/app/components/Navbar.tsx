...
export default function Navbarz() {
    return (
        <>
            <div className="bg-custom-bg bg-no-repeat bg-cover pt-36">
                <nav className="bg-gradient-to-b from-[#d7c3ac] to-gray-900 border-b-2 border-l-2 border-r-2 rounded-b-lg border-red-900 p-4 shadow-xl flex fixed top-0 w-full">
                        <div className="flex justify-center">
                            <Image src={logoplaceholder} alt="Logo placeholder image" className=" h-16 w-56 ml-4 pt-4 rounded-3xl"/>
                        </div>
                        <div className="flex gap-8 text-gray-300 flex ml-24">
                            ...
                            <div className="ml-4">
                                <svg clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                     ...
                                     className="h-10 w-10 text-red-900 items-end mt-4 ml-20">
                                    <path
