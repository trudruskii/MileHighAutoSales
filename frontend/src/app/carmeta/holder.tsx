...
export default function Carmeta(){
    return(
        <>
            <div className="absolute left-[2rem] top-[10rem] w-[37%] h-[31.5rem] border-[2px] border-black bg-gradient-to-b from-gray-100 to-gray-200 flex flex-wrap rounded-lg shadow-red-900 shadow-lg">
                <div className="flex flex-col w-[69%] bg-white text-black px-2">
